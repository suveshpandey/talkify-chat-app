...
const ProfilePage = () => {
    ...
    // return (
    //     <div className=" h-[calc(100vh-4rem)] w-[100%] bg-slate-900 flex items-center justify-center p-4">
    //         <div className="bg-slate-700 rounded-xl shadow-lg p-6 w-full max-w-md transition-all duration-300 hover:shadow-xl">
    //             <div className="relative group">
    //                 <div className="relative w-48 h-48 mx-auto mb-6">
    //                     <img
    //                         src={ authUser.profilePic || "./avatar.png"}
    //                         className="w-full h-full rounded-full object-cover border-4 border-slate-500 text-slate-100 transition-transform duration-300 group-hover:scale-105"
    //                         loading="lazy"
    //                     />
    ...
    //                     <h1 className="text-3xl font-bold text-slate-200">{authUser.username || "username"}</h1>
    //                     <FaCircle
    ...
    //                 <a
    //                     // href={`mailto:${}`}
    //                     className="text-xl font-semibold text-slate-300 hover:text-slate-800 transition-colors duration-300"
    //                 >
    ...
    //                     <button
    //                         className="bg-slate-800 text-white px-6 py-2 rounded-lg hover:bg-slate-900 transition-colors duration-300"
