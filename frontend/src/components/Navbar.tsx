            ...
            <nav className=" h-[4rem] w-full bg-white border-b-[1px] border-gray-600 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <div className="flex gap-x-3">
                        <BiMenuAltLeft onClick={toggleSidebar} className="size-8 block cursor-pointer" />
                    ...
                    <div className="flex gap-x-3 items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        {/* user-profile-page */}
                        <button type="button" onClick={handleProfile} className="flex text-sm bg-gray-800 rounded-full hover:ring-2 ring-slate-700 " id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                            <img className="w-8 h-8 rounded-full object-cover " src={(authUser != null && authUser.profilePic) || "./avatar.png"} alt="user photo" />
                        </button>
                        {/* logout btn */}
